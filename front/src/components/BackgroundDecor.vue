...
@keyframes float {
  ...
  25% { transform: translate(-50%, -50%) translate(10px, -15px) scale(1.05); }
  50% { transform: translate(-50%, -50%) translate(-8px, 10px) scale(0.98); }
  75% { transform: translate(-50%, -50%) translate(5px, 5px) scale(1.02); }
}
.circle {
  position: absolute;
  border-radius: 50%;
